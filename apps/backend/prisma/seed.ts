 ...
 * - 1 school (CSULB)
 * - 30 parking lots with CSULB-accurate locations and capacities
...
const parkingLots: LotSeed[] = [
  // ===== STUDENT LOTS (G LOTS) =====
  {
    ...
    lot_type: LotType.STUDENT, capacity: 180, current_occupancy: 142,
    ...
    ev_charging_stations: 2, motorcycle_spaces: 4, accessible_spaces: 5,
  ...
  },
  {
    ...
    lot_type: LotType.STUDENT, capacity: 425, current_occupancy: 312,
    ...
    ev_charging_stations: 4, motorcycle_spaces: 8, accessible_spaces: 12,
    has_lighting: true, has_cameras: true, has_emergency_phone: true,
  ...
  },
  {
    ...
    lot_type: LotType.STUDENT, capacity: 320, current_occupancy: 245,
    ...
    hours_weekday: { open: '06:00', close: '22:00' },
    hours_saturday: { open: '08:00', close: '18:00' }, hours_sunday: 'CLOSED',
    ev_charging_stations: 2, motorcycle_spaces: 6, accessible_spaces: 8,
  ...
  {
    lot_id: 'G4', lot_name: 'G4 Parking Structure', display_name: 'G4 Structure - Central Campus', lot_number: 'G4',
    lot_type: LotType.STUDENT, capacity: 1250, current_occupancy: 892,
    location_description: 'Central Campus - Multi-Level Structure',
    ...
    ev_charging_stations: 12, motorcycle_spaces: 15, accessible_spaces: 25,
    has_lighting: true, has_cameras: true, has_emergency_phone: true,
    is_covered: true, is_paved: true, levels: 5, penetration_rate: 0.20,
    avg_turnover_minutes: 240, confidence: ConfidenceLevel.HIGH,
  },
  {
    lot_id: 'G5', lot_name: 'Lot G5', display_name: 'Lot G5 - West Campus', lot_number: 'G5',
    lot_type: LotType.STUDENT, capacity: 290, current_occupancy: 198,
    ...
    hours_weekday: { open: '06:00', close: '22:00' },
    hours_saturday: { open: '08:00', close: '18:00' }, hours_sunday: 'CLOSED',
    ev_charging_stations: 3, motorcycle_spaces: 5, accessible_spaces: 7,
    has_lighting: true, has_cameras: true, has_emergency_phone: false,
  ...
  },
  {
    ...
    lot_type: LotType.STUDENT, capacity: 450, current_occupancy: 367,
    ...
    ev_charging_stations: 3, motorcycle_spaces: 7, accessible_spaces: 10,
    has_lighting: true, has_cameras: true, has_emergency_phone: true,
  ...
  },
  {
    ...
    lot_type: LotType.STUDENT, capacity: 380, current_occupancy: 289,
    ...
    hours_weekday: { open: '06:00', close: '22:00' },
    hours_saturday: { open: '08:00', close: '18:00' }, hours_sunday: 'CLOSED',
    ev_charging_stations: 4, motorcycle_spaces: 6, accessible_spaces: 9,
    has_lighting: true, has_cameras: true, has_emergency_phone: true,
  ...
  },
  {
    ...
    lot_type: LotType.STUDENT, capacity: 520, current_occupancy: 445,
    ...
    ev_charging_stations: 5, motorcycle_spaces: 8, accessible_spaces: 12,
    has_lighting: true, has_cameras: true, has_emergency_phone: true,
  ...
  },
  {
    ...
    lot_type: LotType.STUDENT, capacity: 350, current_occupancy: 267,
    ...
    hours_weekday: { open: '06:00', close: '22:00' },
    hours_saturday: { open: '08:00', close: '18:00' }, hours_sunday: 'CLOSED',
    ev_charging_stations: 2, motorcycle_spaces: 5, accessible_spaces: 8,
    has_lighting: true, has_cameras: true, has_emergency_phone: false,
  ...
  },
  {
    ...
    lot_type: LotType.STUDENT, capacity: 280, current_occupancy: 201,
  ...
  },
  {
    ...
    lot_type: LotType.STUDENT, capacity: 200, current_occupancy: 145,
    ...
    hours_weekday: { open: '06:00', close: '22:00' },
    hours_saturday: { open: '08:00', close: '18:00' }, hours_sunday: 'CLOSED',
    ev_charging_stations: 1, motorcycle_spaces: 3, accessible_spaces: 5,
  ...
  },
  {
    ...
    lot_type: LotType.STUDENT, capacity: 340, current_occupancy: 256,
    ...
    ev_charging_stations: 3, motorcycle_spaces: 5, accessible_spaces: 8,
    has_lighting: true, has_cameras: true, has_emergency_phone: true,
  ...
  // ===== EMPLOYEE LOTS =====
  {
    ...
    lot_type: LotType.EMPLOYEE, capacity: 120, current_occupancy: 98,
    ...
    hours_weekday: { open: '06:00', close: '22:00' },
    hours_saturday: { open: '08:00', close: '18:00' }, hours_sunday: 'CLOSED',
    ev_charging_stations: 4, motorcycle_spaces: 2, accessible_spaces: 6,
    has_lighting: true, has_cameras: true, has_emergency_phone: true,
  ...
  },
  {
    ...
    lot_type: LotType.EMPLOYEE, capacity: 95, current_occupancy: 78,
    ...
    hours_weekday: { open: '06:00', close: '22:00' },
    hours_saturday: { open: '08:00', close: '18:00' }, hours_sunday: 'CLOSED',
    ev_charging_stations: 2, motorcycle_spaces: 2, accessible_spaces: 4,
    has_lighting: true, has_cameras: true, has_emergency_phone: false,
  ...
  },
  {
    ...
    lot_type: LotType.EMPLOYEE, capacity: 150, current_occupancy: 112,
    ...
    hours_weekday: { open: '06:00', close: '22:00' },
    hours_saturday: { open: '08:00', close: '18:00' }, hours_sunday: 'CLOSED',
    ev_charging_stations: 3, motorcycle_spaces: 3, accessible_spaces: 7,
    has_lighting: true, has_cameras: true, has_emergency_phone: true,
    is_covered: false, is_paved: true, penetration_rate: 0.20,
    avg_turnover_minutes: 480, confidence: ConfidenceLevel.HIGH,
  },
  {
    lot_id: 'E4', lot_name: 'E4 Parking Structure', display_name: 'E4 Structure - Faculty/Staff', lot_number: 'E4',
    lot_type: LotType.EMPLOYEE, capacity: 350, current_occupancy: 289,
    location_description: 'Central Campus - Employee Structure',
    ...
    hours_sunday: { open: '08:00', close: '20:00' },
    ev_charging_stations: 8, motorcycle_spaces: 5, accessible_spaces: 15,
    has_lighting: true, has_cameras: true, has_emergency_phone: true,
    is_covered: true, is_paved: true, levels: 4, penetration_rate: 0.30,
    avg_turnover_minutes: 480, confidence: ConfidenceLevel.HIGH,
  },
  {
    lot_id: 'E5', lot_name: 'Lot E5', display_name: 'Lot E5 - Faculty/Staff', lot_number: 'E5',
    lot_type: LotType.EMPLOYEE, capacity: 80, current_occupancy: 65,
  ...
  },
  {
    ...
    lot_type: LotType.EMPLOYEE, capacity: 110, current_occupancy: 89,
    ...
    hours_weekday: { open: '06:00', close: '22:00' },
    hours_saturday: { open: '08:00', close: '18:00' }, hours_sunday: 'CLOSED',
    ev_charging_stations: 2, motorcycle_spaces: 2, accessible_spaces: 5,
    has_lighting: true, has_cameras: true, has_emergency_phone: false,
    is_covered: false, is_paved: true, penetration_rate: 0.18,
    avg_turnover_minutes: 480, confidence: ConfidenceLevel.MEDIUM,
  },
  {
    ...
    lot_type: LotType.EMPLOYEE, capacity: 75, current_occupancy: 58,
    ...
    hours_weekday: { open: '06:00', close: '22:00' },
    hours_saturday: { open: '08:00', close: '18:00' }, hours_sunday: 'CLOSED',
    ev_charging_stations: 1, motorcycle_spaces: 1, accessible_spaces: 3,
    has_lighting: true, has_cameras: false, has_emergency_phone: false,
    is_covered: false, is_paved: true, penetration_rate: 0.15,
  ...
  // ===== ADDITIONAL STUDENT LOTS =====
  {
    ...
    lot_type: LotType.STUDENT, capacity: 310, current_occupancy: 234,
    ...
    hours_weekday: { open: '06:00', close: '22:00' },
    hours_saturday: { open: '08:00', close: '18:00' }, hours_sunday: 'CLOSED',
    ev_charging_stations: 2, motorcycle_spaces: 5, accessible_spaces: 7,
    has_lighting: true, has_cameras: true, has_emergency_phone: false,
    is_covered: false, is_paved: true, penetration_rate: 0.11,
    avg_turnover_minutes: 300, confidence: ConfidenceLevel.MEDIUM,
  },
  {
    ...
    lot_type: LotType.STUDENT, capacity: 240, current_occupancy: 178,
  ...
  },
  {
    ...
    lot_type: LotType.EMPLOYEE, capacity: 60, current_occupancy: 45,
    location_description: 'North Campus - Faculty',
  ...
  },
  {
    ...
    lot_type: LotType.EMPLOYEE, capacity: 76, current_occupancy: 63,
    location_description: 'North Campus - Faculty',
    ...
    ev_charging_stations: 2, motorcycle_spaces: 1, accessible_spaces: 5,
    has_lighting: true, has_cameras: false, has_emergency_phone: false,
  ...
  },
  {
    ...
    lot_type: LotType.EMPLOYEE, capacity: 95, current_occupancy: 61,
    location_description: 'South Campus - Faculty',
    building_proximity: ['Faculty Offices'],
    ...
    hours_weekday: { open: '06:00', close: '18:00' },
    hours_saturday: 'CLOSED', hours_sunday: 'CLOSED',
    ev_charging_stations: 2, motorcycle_spaces: 1, accessible_spaces: 6,
    has_lighting: true, has_cameras: false, has_emergency_phone: false,
  ...
  },
  {
    ...
    hours_weekday: { open: '06:00', close: '18:00' },
    hours_saturday: 'CLOSED', hours_sunday: 'CLOSED',
    ev_charging_stations: 3, motorcycle_spaces: 2, accessible_spaces: 8,
    has_lighting: true, has_cameras: true, has_emergency_phone: false,
  ...
  // ===== NAMED LOTS =====
  {
    ...
    lot_type: LotType.STUDENT, capacity: 180, current_occupancy: 117,
    ...
    hours_saturday: { open: '00:00', close: '23:59' },
    hours_sunday: { open: '00:00', close: '23:59' },
    ev_charging_stations: 4, motorcycle_spaces: 3, accessible_spaces: 6,
    has_lighting: true, has_cameras: true, has_emergency_phone: true,
    is_covered: false, is_paved: true, penetration_rate: 0.10,
  ...
  },
  {
    ...
    lot_type: LotType.STUDENT, capacity: 165, current_occupancy: 107,
    ...
    hours_saturday: { open: '00:00', close: '23:59' },
    hours_sunday: { open: '00:00', close: '23:59' },
    ev_charging_stations: 3, motorcycle_spaces: 2, accessible_spaces: 5,
    has_lighting: true, has_cameras: true, has_emergency_phone: true,
    is_covered: false, is_paved: true, penetration_rate: 0.09,
    avg_turnover_minutes: 720, confidence: ConfidenceLevel.MEDIUM,
  },
  {
    lot_id: 'PYR', lot_name: 'Pyramid Lot', display_name: 'Pyramid Lot - Event Parking', lot_number: 'PYR',
    lot_type: LotType.STUDENT, capacity: 320, current_occupancy: 253,
    ...
    ev_charging_stations: 6, motorcycle_spaces: 6, accessible_spaces: 10,
    has_lighting: true, has_cameras: true, has_emergency_phone: true,
    is_covered: false, is_paved: true, penetration_rate: 0.16,
    avg_turnover_minutes: 180, confidence: ConfidenceLevel.HIGH,
  },
